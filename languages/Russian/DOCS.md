...
| 4 | **Зона загрузки** | Перетащите медиафайл сюда или нажмите для выбора через файловый менеджер. Поддерживаются MP4 · MOV · MP3 · WAV · AAC. |
...
| 15 | **Экспорт таймлайна** | Экспортирует сегменты в формате FCPXML или XML для Final Cut Pro, DaVinci Resolve и Adobe Premiere. |
...
| **Automute / Маркеры** | Экспортируйте обнаруженные сегменты как automute-таймлайн или маркеры - в формате FCPXML или XML. Совместимо с Final Cut Pro, DaVinci Resolve и Adobe Premiere. |
...
| **Устранение щелчков** | Добавляет короткое микширование на каждой точке среза, чтобы устранить щелчок, который может возникнуть при резком удалении тишины. |
| **Папка экспорта** | Куда сохраняется обработанный видеофайл после экспорта. |
| **Сброс** | Сбрасывает настройки режима до значений по умолчанию. |
| **Autocut / Маркеры** | Экспортируйте обнаруженные сегменты как autocut-таймлайн или маркеры - в формате FCPXML или XML. Совместимо с Final Cut Pro, DaVinci Resolve и Adobe Premiere. |
...
| **Настройки FCPXML** | Частота кадров, минимальный промежуток между субтитрами и параметры стиля для Final Cut Pro и DaVinci Resolve. |
| **Папка экспорта** | Куда сохраняется обработанный видеофайл после экспорта. |
| **Сброс** | Сбрасывает настройки режима до значений по умолчанию. |
...
**Совет:** Используйте **small** или **medium** для оптимального баланса. Tiny/base - когда важна скорость.
