...
| 4 | **منطقة الرفع** | اسحب وأفلت ملف الوسائط هنا، أو انقر لفتح منتقي الملفات. يقبل MP4 · MOV · MP3 · WAV · AAC. |
...
| 15 | **تصدير الجدول الزمني** | يصدّر المقاطع بصيغة FCPXML أو XML لـ Final Cut Pro وDaVinci Resolve وAdobe Premiere. |
...
| **Automute / علامات** | صدّر المقاطع المكتشفة كجدول زمني automute أو علامات - بصيغة FCPXML أو XML. متوافق مع Final Cut Pro وDaVinci Resolve وAdobe Premiere. |
...
| **إزالة النقر** | يضيف تلاشيًا متقاطعًا قصيرًا عند كل نقطة قطع للتخلص من الصوت النقري الذي قد يحدث عند إزالة الصمت بشكل مفاجئ. |
| **مجلد التصدير** | مكان حفظ ملف الفيديو المعالج بعد التصدير. |
| **إعادة تعيين** | يعيد إعدادات الوضع إلى القيم الافتراضية. |
| **Autocut / علامات** | صدّر المقاطع المكتشفة كجدول زمني autocut أو علامات - بصيغة FCPXML أو XML. متوافق مع Final Cut Pro وDaVinci Resolve وAdobe Premiere. |
...
| **إعدادات FCPXML** | معدل الإطارات والحد الأدنى للفجوة بين الترجمات وإعدادات النمط لـ Final Cut Pro وDaVinci Resolve. |
| **مجلد التصدير** | مكان حفظ ملف الفيديو المعالج بعد التصدير. |
| **إعادة تعيين** | يعيد إعدادات الوضع إلى القيم الافتراضية. |
...
**نصيحة:** استخدم **small** أو **medium** للحصول على أفضل توازن. استخدم tiny/base حين تكون السرعة أهم.
